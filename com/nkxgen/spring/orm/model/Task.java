...
public class Task {
    ...
    public Task(String taskName, Date taskCreationDateTime, String taskType, Task referencedTask,
                String taskCategory, String taskDescription, User taskCreator, BigDecimal numberOfHoursRequired,
                Date taskExpectedDateTime, Date taskCompletedDateTime, User taskSupervisor,
